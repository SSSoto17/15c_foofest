  ...
  return (
    <main>
      <article className="grid grid-cols-4 sm:grid-cols-10 sm:h-full sm:grid-rows-1">
        <Image className="col-start-2 col-span-full row-start-1 sm:col-start-6 sm:object-cover sm:h-full" src={succes} alt="Image from Foo Fest. Photo by Roberto Rendon on Unsplash" placeholder="blur"></Image>
